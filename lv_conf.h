...
#define LV_DISP_ROT_MAX_BUF  (1024U * 1024U)
...
#define LV_IMG_CACHE_DEF_SIZE       200
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "io.h"         /*Header for the system time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (timer_NowTime())     /*Expression evaluating to current system time in ms*/
...
/*QTable (dependencies: lv_label)*/
#define LV_USE_QTABLE    1
#if LV_USE_QTABLE
#  define LV_QTABLE_COL_MAX    12
#  define LV_QTABLE_CELL_STYLE_CNT 16
#endif
/*==================
 * Non-user section
 *==================*/
